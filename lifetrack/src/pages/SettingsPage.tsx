...
import { Download, Upload, Trash2, Plus, Moon, Sun, Database, Tag, Folder } from 'lucide-react'
import toast from 'react-hot-toast'
import { useStore } from '../lib/store'
import { exportJSON, importJSON } from '../utils/export'

export default function SettingsPage() {
  const { theme, toggleTheme, categories, addCategory, deleteCategory, exportAll, importAll, resetAll, notes, tasks, events, goals, dailyEntries, hasDemoData, loadDemoData, clearDemoData } = useStore()
